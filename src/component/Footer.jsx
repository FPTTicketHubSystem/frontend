...
import fileUser from "../assets/file/dieukhoankhachhang.pdf";
import fileOrganizer from "../assets/file/dieukhoanbantochuc.pdf";
      ...
      <div className="container">
        <div className="row row-cols-1 row-cols-md-3 g-4">
          <div className="col mb-4">
            <h5 href="#" className="mb-2 fw-bold">
              Hỗ trợ
            </h5>
            <p>
              {" "}
              <i class="bi bi-calendar"></i> Thứ 2 - Thứ 6 (8:30 - 18:30)
            </p>
            <a
              href="tel:0961774218"
              className="fw-bold mb-2"
              style={{ textDecoration: "none", color: "#EC6C21" }}
            >
              <i class="bi bi-telephone"></i> 0961774218
            </a>
            <h5 className="mt-4 fw-bold">Email</h5>
            <p class="text-white fw-bold">
              <i class="bi bi-envelope"></i> fpttickethub@gmail.com
            </p>
          </div>
          ...
          <div className="col mb-4">
            <h5 className="mb-4 fw-bold">
              ...
              >
                <i class="bi bi-postcard-heart"></i> Diễn đàn
              </a>
            </h5>
